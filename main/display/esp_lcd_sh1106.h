 ...
 *
 */
#define ESP_LCD_IO_I2C_SH1106_ADDRESS  (0x3C)
#define ESP_LCD_IO_I2C_SH1106_ADDRESS1 (0x3D)

/**
 * @brief Touch IO configuration structure
 *
 */
#define ESP_LCD_IO_I2C_SH1106_CONFIG()             \
    {                                              \
        .dev_addr = ESP_LCD_IO_I2C_SH1106_ADDRESS, \
